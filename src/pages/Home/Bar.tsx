...
function TrackOnPlayPlug() {
  return (
    <div className={clsx('player__track-on-play', 'track-on-play-plug')}>
      <div
        className={clsx(
          'track-on-play__contain',
          'track-on-play-plug__contain',
        )}
      >
        <div
          className={clsx('track-on-play__image', 'track-on-play-plug__image')}
        ></div>
        <div
          className={clsx('track-on-play__name', 'track-on-play-plug__name')}
        ></div>
        <div
          className={clsx(
            'track-on-play__author',
            'track-on-play-plug__author',
          )}
        ></div>
      </div>
